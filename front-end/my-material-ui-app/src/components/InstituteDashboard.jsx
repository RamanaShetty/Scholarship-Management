...
import Scholarships from './Institute/Scholarships'
import StudentApproval from './Institute/StudentApproval'
...
function InstituteDashboard() {
    ...
    return (
        ...
        {(activeSection==="Scholarships" && <Scholarships/>)}
        {(activeSection==="StudentApproval" && <StudentApproval/>)}
        </>
    )
}
